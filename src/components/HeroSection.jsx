    ...
    <div>
      ...
      px-6 mbd:px-16 lg:px-32 text-white bg-[url(${bgImage})]
       bg-no-repeat bg-cover bg-center h-screen`}>
        ...
        {/* Head lines to  */}
        <div>
          <p className=' bg-[#49B9FF]/50 px-20 w-full font-bold py-1 rounded-full mt-20'>The Ultimate Hotel Experience</p>
          ...
          <p className='max-w-130 mt-2 text-sm md:text-base'>Unparlled luxury and comfort await at the world's most exclusive hotels and resorts. start your journey today</p>
        </div>
          ...
          <form className='bg-white text-gray-500 rounded-lg px-6 py-4  flex flex-col md:flex-row max-md:items-start gap-4 max-md:mx-auto'>
            ...
            <div>
              ...
              <input list='destinations' id="destinationInput"
                type="option" className=" rounded border border-gray-200 px-3 py-1.5 mt-1.5 text-sm outline-none"
                placeholder="Type here" required />

              {/* city list shows to them */}
