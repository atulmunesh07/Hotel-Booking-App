        ...
        <div className='bg-[#F6F9FC] text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                <div className='max-w-80'>
                    ...
                    <img src='https://static.vecteezy.com/system/resources/thumbnails/047/247/050/small_2x/hotel-3d-illustration-png.png' alt="logo" className='mb-4 h-8 md:h-9' />
                    <span className='font-black text-2xlm ml-2 hover:text-blue-500'>HotelBooking.com</span>
                    </div>
                    <p className='text-sm'>
                     Discover the world's most extraordinary place to stay , from boutiqe hotel to luxury vilas and private islands
                    </p>
