...
function HotelCard({ room, index }) {
    return (
        ...
        className=' relative max-w-70 w-full rounded-xl
                 overflow-hidden bg-white text-gray-500/90 shadow-[0px_4px_rgba(0,0,0,0.2)]'
        >
            ...
            <div className='p-4 pt-5'>
                <div className='flex items-center justify-between'>
                    ...
                    <div className='flex items-center gap-1'>
                        <img src={assets.starIconFilled} alt="stat-icon" />4.5
                    </div>
                </div>
                ...
                <div className=' flex items-center justify-between mt-4'>
                    ...
                    <button className='px-4 py-2 text-sm font-medium border border-gray-300 
                         rounded hover:bg-gray-50 translate-all cursor-pointer'>Book know</button>
                </div>
            </div>
